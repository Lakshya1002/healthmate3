    ...
    <div className="chart-container">
      ...
      <ResponsiveContainer width="100%" height={300}>
        ...
        >
          ...
          <YAxis stroke="#64748b" allowDecimals={false} domain={['dataMin - 5', 'dataMax + 5']} />
          <Tooltip
            contentStyle={{
          ...
          />
          <Legend />
          <Line type="monotone" dataKey={dataKey} name={name} stroke={color} strokeWidth={2} activeDot={{ r: 8 }} connectNulls />
        </LineChart>
      </ResponsiveContainer>
    </div>
  );
